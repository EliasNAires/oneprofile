...
Servidor de Elias, por SSH vía ZeroTier (`ssh elitedesk1`; el usuario está en el grupo `docker` desde el
2026-09-13, así que Docker corre sin `sudo` y un subagente puede operar prod sin credenciales). No compila:
