...
public class BoardProbe {
	...
	private static final Log logger = LogFactory.getLog(BoardProbe.class);
	 ...
	 */
	public BoardProbe(Ats ats, BoardReader reader, Companies companies, Clock clock, Duration pace) {
		this.ats = ats;
		this.reader = reader;
