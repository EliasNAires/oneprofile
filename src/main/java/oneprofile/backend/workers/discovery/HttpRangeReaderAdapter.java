 ...
 */
@Component
public class HttpRangeReaderAdapter implements RangeReaderPort {
	...
	@Autowired
	public HttpRangeReaderAdapter() {
		this(DATA_COMMONCRAWL, UserAgent.VALUE, ATTEMPTS, BACK_OFF);
	}
	 ...
	 */
	HttpRangeReaderAdapter(URI base, String userAgent, int attempts, Duration backOff) {
		if (attempts < 1) {
