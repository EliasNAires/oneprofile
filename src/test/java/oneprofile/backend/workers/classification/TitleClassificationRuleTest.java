...
class TitleClassificationRuleTest {
	...
	class Rulings {
		...
		void overrideTheVerdictTheProcedureWouldHaveReached() {
			...
			assertThat(classify("manufacturing systems engineer"))
				.isEqualTo(Classification.unknown(UnknownReasonEnum.SCOPE_AMBIGUITY));
	...
	class Heads {
		...
		void aHeadNoListReachesIsOurBacklogRatherThanTheCorpusAmbiguity() {
			assertThat(classify("security roboticist")).isEqualTo(Classification.unknown(UnknownReasonEnum.UNRULED));
		}
		...
		void theFirstHeadNamedIsTheHead() {
			assertThat(classify("writer software engineer")).isEqualTo(Classification.unknown(UnknownReasonEnum.UNRULED));
		...
		void aKnownHeadThatCarriesEngineeringAndNoDomainIsTheCorpusAmbiguity() {
			assertThat(classify("engineer")).isEqualTo(Classification.unknown(UnknownReasonEnum.DOMAIN_AMBIGUITY));
		}

		@Test
		void aKnownHeadThatCarriesNoEngineeringIsStillOurBacklog() {
			assertThat(classify("content writer")).isEqualTo(Classification.unknown(UnknownReasonEnum.UNRULED));
		}
	...
	class Modifiers {
		...
		void aSoftwareQualifierUnderAHeadThatCarriesNoEngineeringDecidesNothing() {
			assertThat(classify("software writer")).isEqualTo(Classification.unknown(UnknownReasonEnum.UNRULED));
		}
	...
	class MarkerClasses {
		...
		void aMarketMarkerSettlesNothingUnderADomainFreeHead() {
			assertThat(classify("audit analyst")).isEqualTo(Classification.unknown(UnknownReasonEnum.DOMAIN_AMBIGUITY));
		}
	...
	class Managers {
		...
		void areInWhereWhatTheyManageIsAnEngineeringFunction() {
			...
			assertThat(classify("technical lead")).isEqualTo(Classification.unknown(UnknownReasonEnum.DOMAIN_AMBIGUITY));
		}
	...
	class Coverage {
		...
		void readsSolutionsAsASoftwareDomainOnlyWhereARulingSaysSo() {
			assertThat(classify("partner solutions engineer latam")).isEqualTo(Classification.unknown(UnknownReasonEnum.DOMAIN_AMBIGUITY));
			assertThat(classify("solutions engineering lead healthcare life sciences")).isEqualTo(Classification.unknown(UnknownReasonEnum.DOMAIN_AMBIGUITY));
	...
	class CoverageFromIterationSeven {
		...
		void pinsWhatTheNewMarkersCost() {
			...
			assertThat(classify("server engineer")).isEqualTo(Classification.unknown(UnknownReasonEnum.DOMAIN_AMBIGUITY));
		}
	...
	class CoverageFromIterationNine {
		...
		void readsSalesAsTheFunctionItNamesRatherThanTheMarketItServes() {
			...
			assertThat(classify("sales engineer")).isEqualTo(Classification.unknown(UnknownReasonEnum.DOMAIN_AMBIGUITY));
		}
	...
	class Matching {
		...
		void readsAWordOnlyWhereTheTitleNamesItWhole() {
			...
			assertThat(classify("container engineer")).isEqualTo(Classification.unknown(UnknownReasonEnum.DOMAIN_AMBIGUITY));
		}
		...
		void saysNothingAboutATitleThatIsEmpty() {
			assertThat(classify("")).isEqualTo(Classification.unknown(UnknownReasonEnum.UNRULED));
		}
	...
	class RankHeads {
		...
		void areOnlyReadAsAHeadWhereTheHeadListAlsoNamesThem() {
			...
			assertThat(classify("leads")).isEqualTo(Classification.unknown(UnknownReasonEnum.UNRULED));
			assertThat(classify("qualified leads")).isEqualTo(Classification.unknown(UnknownReasonEnum.UNRULED));
		}

		@Test
		void leaveABareRankHeadAsTheCorpusAmbiguity() {
			assertThat(classify("manager")).isEqualTo(Classification.unknown(UnknownReasonEnum.DOMAIN_AMBIGUITY));
		}
	...
	class TestAndQualityAssurance {
		...
		void areNotSoftwareQualifiersOnTheirOwn() {
			...
			assertThat(classify("test engineer")).isEqualTo(Classification.unknown(UnknownReasonEnum.DOMAIN_AMBIGUITY));
	...
	class CoverageFromRoundFourteen {
		...
		void aSupportEngineerIsReadByItsQualifierLikeAnyEngineer() {
			...
			assertThat(classify("application support engineer")).isEqualTo(Classification.unknown(UnknownReasonEnum.DOMAIN_AMBIGUITY));
			assertThat(classify("production support engineer")).isEqualTo(Classification.unknown(UnknownReasonEnum.DOMAIN_AMBIGUITY));
	...
	private static Classification domainAmbiguity() {
		return Classification.unknown(UnknownReasonEnum.DOMAIN_AMBIGUITY);
	}

	private static Classification scopeAmbiguity() {
		return Classification.unknown(UnknownReasonEnum.SCOPE_AMBIGUITY);
	}
